...
const CourseDetail = () => {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: `url(${courseDetailBg})`,
    ...
    >
      <div className='h-full w-full bg-[#0000008b] flex items-center justify-center'>
        <div className='relative h-[90%] w-[90%] flex items-center justify-evenly bg-[#121928] rounded-xl shadow-xl shadow-black'>
          <div
            className='h-[90%] w-[45%] flex flex-col items-start justify-evenly rounded-xl'
            style={{ padding: '0 5vw' }}
          >
            <h2 className='rounded-lg text-3xl font-bold'>
              {courseDetails.title}
            </h2>
            <p
              className='min-h-[50%] w-full rounded-lg text-xl bg-zinc-800 text-zinc-600 font-semibold overflow-y-scroll'
              style={{ padding: '2vw' }}
            >
              <i>{courseDetails.description}</i>
            </p>
            <h2 className='rounded-lg text-2xl font-bold text-green-600'>
          ...
          <div
            className='h-[90%] w-[45%] rounded-xl shadow-zinc-500 shadow-md'
            style={{
